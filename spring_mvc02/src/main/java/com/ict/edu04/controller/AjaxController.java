...
public class AjaxController {
	...
	@RequestMapping(value = "/weather2Xml", produces="text/xml; charset=utf-8")
	public String weather2Xml() {
		return fetchWeather2("xml");
	}
	
	@RequestMapping(value = "/weather2Json", produces="application/json; charset=utf-8")
	public String weather2Json() {
	...
	private String fetchWeather2(String dataType) {
		BufferedReader rd = null;
		HttpURLConnection conn  = null;
		try {
			// 오늘날짜구하기
